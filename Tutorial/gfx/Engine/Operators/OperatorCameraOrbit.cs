...
namespace FlexRobotics.gfx.Engine.Operators
{
        ...
        Operator
    {
        ...
        protected override void InputOnMouseDown(object sender, IMouseEventArgs args)
        {
            ...
            MouseDownView = MouseDownCameraInfo.GetTransformationMatrix(Space.Screen, Space.View).Transform(args.Position.ToPoint3D(0));
        ...
        protected override void InputOnMouseMove(object sender, IMouseEventArgs args)
        {
            ...
            var mouseMoveView = RenderHost.CameraInfo.GetTransformationMatrix(Space.Screen, Space.View).Transform(args.Position.ToPoint3D(0));
